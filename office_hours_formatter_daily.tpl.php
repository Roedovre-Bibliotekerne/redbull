...
<span class="hours">
  <span class="open"><?php print redbull_office_hours_format_time($hours['open']); ?></span> –
  <span class="close"><?php print redbull_office_hours_format_time($hours['close']); ?></span>
</span>
