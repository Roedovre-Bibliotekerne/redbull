...
<div id="ting-item-<?php print $object->localId; ?>"  class="ting-object-view ting-item">
  <div class="leftside">
    <?php if ($image) { ?>
      <?php print $image; ?>
    <?php } ?>
  ...
  ?>
  <?php if ($other_titles) { ?>
    <h2 class="title2"><?php print $other_titles; ?></h2>
  <?php } ?>
  <?php if ($alternative_titles) { ?>
    <?php foreach ($alternative_titles as $title) { ?>
      <h2 class="title3">(<?php print check_plain($title); ?>)</h2>
    <?php } ?>
  <?php } ?>
  ...
  <p><?php if (isset($additional_main_content)) { print drupal_render($additional_main_content); } ?> <?php print $abstract; ?></p>
  ...
  <div class="ting-object-info clear-block">
